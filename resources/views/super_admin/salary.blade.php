              ...
              <form action="salary" method="POST" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="designation" placeholder="Enter designation" value="{{old('designation')}}" class="form-control" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="month" placeholder="Enter month" value="{{old('month')}}" class="form-control" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="salary" placeholder="Enter salary" value="{{old('salary')}}" class="form-control" />
