                   ...
                   {!! Form::open(['url' =>URL::current()]) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                          ...
                          {!! Form::text('old_password', Request::old('old_password'),array('class' => 'form-control' , 'placeholder' => 'Enter Previous Password' )) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            {!! Form::text('password', Request::old('password'),array('class' => 'form-control' , 'placeholder' => 'Enter New Password' )) !!}
